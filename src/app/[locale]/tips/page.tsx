  ...
  },
  {
    ...
    tips: [
      ...
      },
      {
        ...
        description: {
          es: 'En muchas zonas de montaña no hay cobertura de red celular. Un handy VHF es una de las formas más confiables y económicas de comunicarse con otros montañistas o pedir ayuda en una emergencia.',
          en: 'In many mountain areas there is no cell coverage. A VHF handy radio is one of the most reliable and affordable ways to communicate with other hikers or call for help in an emergency.',
        },
        items: {
          es: [
            'Frecuencia de Emergencia en Montaña (FEM): 140.970 MHz. Uso libre en algunos lugares, pero no hay escucha garantizada: funciona solo si alguien está monitoreando',
            'Canal general entre grupos: 139.970 MHz / Secundario: 138.510 MHz. Recomendado acordarlos previamente con el grupo para coordinación',
            'Baofeng UV-5R: económico, liviano y suficiente para trekking. Alcance típico: 1–5 km en terreno complejo, hasta 15–20 km en línea de vista',
            'Sin cobertura celular, los servicios de emergencia por teléfono NO funcionan. Se recomienda complementar con dispositivos satelitales y aviso previo del itinerario',
          ],
          en: [
            'Mountain Emergency Frequency (FEM): 140.970 MHz. License-free in some areas, but no guaranteed monitoring: only works if someone is listening',
            'General channel between groups: 139.970 MHz / Secondary: 138.510 MHz. Recommended to agree on channels with your group beforehand',
            'Baofeng UV-5R: affordable, lightweight and sufficient for trekking. Typical range: 1–5 km in complex terrain, up to 15–20 km line of sight',
            'Without cell coverage, emergency phone services do NOT work. Complement with satellite devices and always share your itinerary beforehand',
          ],
        },
      },
      {
