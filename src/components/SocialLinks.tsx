...
export default function SocialLinks({ links, locale }: SocialLinksProps) {
  const hasAnyLink = links.website || links.instagram || links.facebook || links.whatsapp || links.youtube || links.twitter;
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
      <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">
        {locale === 'es' ? 'Enlaces Oficiales' : 'Official Links'}
      </h3>
      <div className="flex flex-wrap gap-2 sm:gap-3">
        ...
        {links.website && (
          ...
          >
            ...
            <span>{locale === 'es' ? 'Sitio Web' : 'Website'}</span>
          </a>
        )}
